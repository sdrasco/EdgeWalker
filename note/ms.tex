...
\caption{
    ...
    \label{fig:sequence}
\end{figure}
Note that once the strikes are critically inverted with loss eliminated, further strike separation widens the region $S_+ < S < S_-$ in which the profit $\varphi = K_P - K_C - \Pi$, is independent of the underlying price.
