...
\Pi = P + C~.
\end{equation}
The sequence shown in Fig.~\ref{fig:sequence} demonstrates the effect of shifting the strikes $K_C$ and/or $K_P$,  in such a way that eventually its breakeven points defy their meaning, become inverted $S_- \geq S_+$, and $\varphi(S) \geq 0$, for all $S$.
\begin{figure*}[hb]
    \centering
