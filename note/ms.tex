...
\caption{
    ...
    \label{fig:sequence}
\end{figure}
Note that after the strikes are critically inverted, with loss eliminated, the region in which the profit
is independent of the underlying price will shrink to a point when the breakpoints also invert.  Further separation of the strikes widens the region
