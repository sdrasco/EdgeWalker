...
The final two strangles in Fig.~\ref{fig:sequence} would amount to an arbitrage in that they are completely lossless.  Unsurprisingly, realistic premiums prohibit these positions.  To see this, note that the arbitrage-like scenarios have minimum profit (\ref{eq:minimum}).
