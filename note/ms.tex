...
\begin{figure*}[hb]
    ...
    a critically inverted lossless strangle where $0 < (K_P - K_C) = \Pi$ (bottom left),
    and lastly a generic inverted lossless strangle where both the strikes and the breakeven points are inverted with $\Pi < (K_P - K_C)$ (bottom right).}
    \label{fig:sequence}
\end{figure*}
