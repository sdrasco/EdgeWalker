...
\begin{figure}[hb]
    \centering
    \includegraphics[width=0.45\textwidth]{put.png}
    \caption{Profit and loss curves for a long put.}
    \label{fig:put}
\end{figure}
...
\begin{figure}[hb]
    \centering
    \includegraphics[width=0.45\textwidth]{call.png}
    \caption{Profit and loss curves for a long call.}
    \label{fig:call}
\end{figure}
...
\begin{figure}[hb]
    \centering
    \includegraphics[width=0.45\textwidth]{strangle.png}
    \caption{Profit and loss curves for a generic strangle.}
    \label{fig:strangle}
\end{figure}
...
\begin{figure*}[hb]
    \centering
    \includegraphics[width=0.3\textwidth]{sequence1.png}
    \includegraphics[width=0.3\textwidth]{sequence2.png}
    \includegraphics[width=0.3\textwidth]{sequence3.png}
    \includegraphics[width=0.3\textwidth]{sequence4.png}
    \includegraphics[width=0.3\textwidth]{sequence5.png}
