...
\caption{
    ...
    \label{fig:sequence}
\end{figure}
Note that once the strikes are critically inverted with loss eliminated, further strike separation widens the region in which the profit
\begin{equation} \label{eq:minimum}
\varphi(S_+ < S < S_-) = \varphi_{\min} = K_P - K_C - \Pi \geq 0~,
\end{equation} 
is independent of the underlying price.
